...
const imagesEstop = [{nome: `images/estop/telaPrincipal.jpg`, descricao: 'Tela Principal.'},{nome: `images/estop/telaCliente.jpg`,descricao: 'Aba do Cliente.'},{nome: `images/estop/login.png`, descricao: 'Tela de Login.'},{nome: `images/estop/telaCaixa.jpg`, descricao: 'Aba do Caixa.'},{nome: `images/estop/telaPreco.jpg`, descricao: 'Aba de Preços.'},{nome: `images/estop/telaGerencia.jpg`, descricao: 'Aba da Gerencia.'},];
const imagesDugsmash = [{nome: `images/dubsmash/startGame.png`, descricao: 'Tela Principal.'},{nome: `images/dubsmash/jogo.png`,descricao: 'Tela do Game.'},{nome: `images/dubsmash/venceu.png`, descricao: 'Tela do Vencedor.'},{nome: `images/dubsmash/gameOver.png`, descricao: 'Tela do Game Over.'},{nome: `images/dubsmash/telasMobile.png`, descricao: 'Telas Mobile.'},];
